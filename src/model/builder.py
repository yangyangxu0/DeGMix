...
def get_backbone(model_backbone,
    ...
    if model_backbone == 'HRNet18-S':
        ...
        idx_to_planes = {0: 96, 1: 192, 2: 384, 3: 768}
    elif model_backbone == 'ViT-L':
        backbone = backbones.vit_l(pretrained=pretrained)
        idx_to_planes = {0: 96, 1: 192, 2: 384, 3: 768}
    elif model_backbone == 'ViT-B':
        backbone = backbones.vit_b(pretrained=pretrained)
        idx_to_planes = {0: 96, 1: 192, 2: 384, 3: 768}
    else:
        raise ValueError
...
def get_head(head_name,
    ...
    elif head_name == 'DemtViTHead':
        from .heads.demt_vit_head import DemtViTHead
        partial_head = partial(DemtViTHead)
